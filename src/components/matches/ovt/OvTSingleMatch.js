			...
			<div className="row">
				<div className="col s5 center-align">
					<div className="row">
						...
						{match.winner1 ? <div className="col s12"> & {match.winner[1]}</div> : ''}
					</div>
				</div>
				...
				<div className="col s5 center-align">
					<div className="row">
						...
						{match.loser1 ? <div className="col s12"> & {match.loser[1]}</div> : ''}{' '}
					</div>
				</div>
			</div>
