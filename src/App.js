...
class App extends Component {
    render() {
        return (
            <BrowserRouter>
                <div className="center-align cyan-text text-darken-1 title">
                ...
                <Switch>
                    ...
                    />
                    <Route
                        path="/tvtplayer_details/:id"
                        component={TvTPlayerDetails}
                    />
                    <Route
                        path="/tvtmatch_details/:id"
                        component={TvTMatchDetails}
                    />
                    <Route
                        path="/ovtplayer_details/:id"
                        component={OvTPlayerDetails}
                    />
                    <Route
                        path="/ovtmatch_details/:id"
                        component={OvTMatchDetails}
                    />
                </Switch>
                <ToastContainer
